...
#+begin_src conf
  ...
  for_window [class="virt-manager"] floating enable move position center resize set 680 680
  for_window [class="(?i)steam.*"] floating enable move position center resize set 680 680
#+end_src
