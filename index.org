...
*** music
#+begin_src conf
  bindsym $mod+Mod1+m exec $terminal -e ncmpcpp
#+end_src
*** htop
#+begin_src conf
  bindsym $mod+Mod1+h exec $terminal -e htop
#+end_src
*** nmtui
#+begin_src conf
  bindsym $mod+Mod1+w exec $terminal -e nmtui
#+end_src
*** khal
#+begin_src conf
  bindsym $mod+Mod1+k exec $terminal -e khal interactive
#+end_src
*** vim
#+begin_src conf
  bindsym $mod+Mod1+v exec $terminal -e vim
#+end_src
*** dired
#+begin_src conf
